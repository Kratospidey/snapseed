    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.content}>
        <View style={styles.headerRow}>
          <AppIconButton onPress={handleClose}>
        ...
        <GlassSurface style={styles.selectionSummary} useBlur={false}>
          ...
          {permission?.accessPrivileges === 'limited' ? (
            <AppChip label="Manage Access" onPress={() => void mediaGateway.openLimitedAccessPicker()} />
          ) : null}
        </GlassSurface>
            ...
            <FlatList
              ...
              renderItem={({ item }) => {
                ...
                return (
                  ...
                  >
                    {isSelected ? (
                      <View pointerEvents="none" style={styles.assetSelectionRing} />
                    ) : null}
                    <ImportAssetPreview
            ...
            >
              {`Review ${
                selectedAssetIds.length > 0
                  ? `${selectedAssetIds.length} Capture${selectedAssetIds.length === 1 ? '' : 's'}`
                  : 'selection'
              }`}
            </AppButton>
          </>
